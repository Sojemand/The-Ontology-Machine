...
def libreoffice_dir(module_root_path: Path | None = None) -> Path:
    return _build_layout(module_root_path, None).libreoffice_dir
...
def _build_layout(module_root_path: Path | None = None, app_home_path: Path | None = None) -> PathLayout:
    ...
    runtime_root = resolved_module_root / _RUNTIME_DIR
    return PathLayout(
        ...
        libreoffice_dir=runtime_root / _LIBREOFFICE_DIR,
