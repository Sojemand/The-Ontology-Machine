...
if not defined PYTHON_EXE (
    ...
    echo The "Audio Transcription Extractor" folder must stay inside the Ontology Machine Extractor_Tools folder.
...
start "Audio Transcription Extractor" "%PYTHON_EXE%" "%ROOT%audio_transcription_extractor.py"
exit /b 0
