...
"%SOURCE_PYTHON%" "%SCRIPT%" --module "05 - Corpus Builder" --source-python "%SOURCE_PYTHON%" %*
exit /b !ERRORLEVEL!

:fallback_python
py -3.11 "%SCRIPT%" --module "05 - Corpus Builder" %*
if not errorlevel 1 exit /b 0

python "%SCRIPT%" --module "05 - Corpus Builder" %*
exit /b %ERRORLEVEL%
