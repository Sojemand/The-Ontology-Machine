"""Core contract handlers shared by the dispatch surface."""

from __future__ import annotations

from ..context import ModuleContext
from ..models.types import EmbeddingRequest
from ..services import apply_semantic_release, build_load_bundle, generate_embeddings as run_embedding_generation, load_batch
from .types import ActivateSemanticReleaseCommand, GenerateEmbeddingsCommand, LoadDocumentCommand
...
def activate_semantic_release(command: ActivateSemanticReleaseCommand, *, context: ModuleContext) -> dict:
    ...
    return {
        ...
        "target_identity_proof": {
            "database_path": str(command.corpus_db_path or ""),
